    ...
    <section
      ...
      <div className="mx-auto w-full max-w-7xl">
        <header className="mx-auto mb-14 max-w-2xl text-center md:mb-16">
          <div className="mb-6 flex items-center justify-center gap-4 font font-mono text-xs uppercase tracking-[0.28em] text-[#CFA50E]">
...
//                   <div className="flex items-center justify-between border-b border-[#294261] pb-3 font-mono text-[8px] uppercase tracking-[0.16em] text-[#CFA50E]">
